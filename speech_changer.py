...
# Только для видео с одним человеком
def update_voice(voice_filename, video_filename, output_filename, use_enhancer=False):
    ...
    frames = lip_sync.sync(frames, voice_filename, orig_clip.fps, use_enhancer)
...
if __name__ == '__main__':
    ...
    update_voice(voice_filename=args.voice_filename, video_filename=args.video_filename,
